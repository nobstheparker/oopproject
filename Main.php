...
class Main {
    ...
    public function deleteMenu() {
        ...
        $this->roster->displayEmployees($this->roster->getRoster()); // Display employees with accurate "Employee Number"
        
        $empNumber = (int) readline("Enter employee number to delete: ");
        
        // Attempt to remove the employee at the specified index
